// Símbolo internacional de accesibilidad (silla de ruedas), viewBox 24x24.
// Compartido por el pin de plaza (SpotMarker) y el badge de cluster
// (MapView) para que ambos lleven la misma imagen de marca PMR.
export const WHEELCHAIR_GLYPH = `
